...
int main(int argc,char* argv[]) {
  ...
  /*unsigned char *refData = frame_ref.data;
  int cam_width_ref = frame_ref.cols;
  int cam_height_ref = frame_ref.rows;
  int numOfPixels_ref = 320*240;
  int widthStepRef = frame_ref.step; //in case cols != strides
  int nChannelsRef = frame_ref.channels();*/
